...
Error_types::Bind_error::Bind_error(type_socket* input_socket) : error_message("Binding error! Bind() failed."), socket_to_close(input_socket) { }
...
Error_types::Listen_error::Listen_error(type_socket *input_socket) : error_message("Listening error! Listen() failed."), socket_to_close(input_socket) { }
